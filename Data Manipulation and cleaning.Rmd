...
```{r,message=FALSE}
corruption_EDA=read_csv("C:/Users/Leon/Desktop/p8105_final_project/data/corruption_index.csv")|>
  janitor::clean_names()|>
  pivot_longer(
...
corruption_EDA=left_join(corruption_EDA,GDP_EDA,by = join_by(country_code, year))
```
