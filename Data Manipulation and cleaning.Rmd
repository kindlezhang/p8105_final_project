...
We need the coordinates of the countries for the future EDA session. This dataset comes from [Google for Developers](https://developers.google.com/public-data/docs/canonical/countries_csv?hl=en).
